...
export const AirplaneMap: React.FC<Props> = ({ heading, positions }) => {
  ...
  return (
    <MapContainer
      ...
      zoom={4}
      style={{ height: '500px', width: '100%', marginTop: 24 }}
    >
      <TileLayer
        attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors; Matthias Schäfer, Martin Strohmeier, Vincent Lenders, Ivan Martinovic and Matthias Wilhelm.
